...
import com.monsoon.community.service.FollowService;
...
public class UserController implements CommunityConstant {
    ...
    public String uploadHeader(MultipartFile headerImage, Model model) { // 专有类型来接受图片
        if (headerImage == null) {
    ...
    public void getHeader(@PathVariable("fileName") String fileName, HttpServletResponse response) { // 输出的是图片，需要手动用response输出，所以是void
        ...
        ) // 读取这个文件然后得到一个输入流，放在这里面会自动关闭(前提是有close方法)
        {
