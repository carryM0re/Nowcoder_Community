...
import com.monsoon.community.dao.LoginTicketMapper;
import com.monsoon.community.dao.UserMapper;
...
@Service
public class UserService implements CommunityConstant { // 需要用到常量，所以继承该接口
...
//        return userMapper.selectById(id);
    ...
    public Map<String, Object> register(User user){
        ...
        // 注册用户
        user.setSalt(CommunityUtil.generateUUID().substring(0,5)); // 短一点，只取5位
